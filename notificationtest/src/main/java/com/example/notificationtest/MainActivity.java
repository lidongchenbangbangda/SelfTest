...
import com.example.notificationtest.utils.BaseActivity;
...
////				.setNumber(number)//显示数量
//                .setTicker("测试通知来啦");//通知首次出现在通知栏，带上升动画效果的
        Bitmap bitmap= BitmapFactory.decodeResource(getResources(),R.drawable.sing_icon);
        //mBuilder.setSmallIcon(R.drawable.sing_icon);
...
//		mNotification.notify(getResources().getString(R.string.app_name), notiId, mBuilder.build());
    ...
    public void showBigStyleNotify() {
        ...
        String[] events = new String[]{"1111","2222","3333","4444","5555"};
...
//		//PendingIntent 跳转动作
        ...
        //设置通知  消息  图标
        mNotification.icon = R.drawable.sing_icon;
        //在通知栏上点击此通知后自动清除此通知
...
//		notification.flags = Notification.FLAG_AUTO_CANCEL; //在通知栏上点击此通知后自动清除此通知
        ...
        String apk_path = Environment.getExternalStorageDirectory()+"project.apk";
